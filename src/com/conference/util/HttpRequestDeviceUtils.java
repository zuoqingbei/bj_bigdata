/*
 * Copyright (c) 2013 <a href="http://www.med626.com.cn">上海医师在线 信息技术有限公司</a>  All Rights Reserved.                	 
*/                                                                
...
public class HttpRequestDeviceUtils {
    ...
    */
     ...
     * 判断是否掌上医讯内置浏览器
     * @author Chengzl
     * @date 2015年5月26日下午3:58:37
     * @param request
     * @return
     */
    public  static boolean isDoctor(HttpServletRequest request){
    	String userAgent = request.getHeader("user-agent");
    	if(userAgent!=null&&userAgent.contains("doctorpda")){
    		return true;
    	}else{
    		return false;
    	}
