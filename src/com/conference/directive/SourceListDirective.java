 ...
 *素材分析列表数据
 */
public class SourceListDirective implements TemplateDirectiveModel,Constant{
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars,
		...
		String sqlWhere=SqlUtil.joinSqlForSource(request);
		Page<Record> pager=FctOrigin.dao.originAnalysis(sqlWhere, pageNum, pageSize);
